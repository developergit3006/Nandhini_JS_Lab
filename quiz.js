...
const qA1 = new QuestionAnswerOptions(question1,
...
const qA2 = new QuestionAnswerOptions(question2,
...
const qA3 = new QuestionAnswerOptions(question3,
    [answer1Q3, answer2Q3, answer3Q3, answer4Q3], answer1Q3);
...
const qA4 = new QuestionAnswerOptions(question4,
...
const qA5 = new QuestionAnswerOptions(question5,
...
function QuizApp(questionAnswerOptionsArrayObj) {
    ...
    this.calculatePercentage = function () {
        const percentageValue = (this.getScore() / this.questionAnswerOptionsArrayObj.length) * 100;
    ...
    this.addListenersForAnswerButtons = function(){
        ...
        for(let index=0; index < 4; index++){
            ...
            answerButtonElement.onclick = function(event){
                ...
                const qAnswerOptionsObj = currentQuizAppObj.questionAnswerOptionsArrayObj[currentQuizAppObj.pageIndex];

                const result = qAnswerOptionsObj.correctAnswer(userSuppliedAnswer);
